...
const Dashboard = () => {
  ...
  return (
    <main className="mainC">
        ...
        <div className="grid-item text-content">
          ...
          <div className="btn-container">
            ...
            <button className="btn2">
              <a href="https://play.google.com/store/apps/details?id=com.kasir.kasirbersih" target="_blank" rel="noopener noreferrer">Download</a>
            </button>
          </div>
        </div>
      ...
      <div className="main-content2" id="about">
      ...
      {/* Footer harus berada di luar semua div konten */}
      <Footer />
    </main>
  );
};
